...
//macros
#define LOG(text) RenderWindow::Get()->log(text,LogType::LOG)
#define LOG_HIGHLIGHT(text) RenderWindow::Get()->log(text,LogType::HIGHLIGHT)
#define LOG_WARNING(text) RenderWindow::Get()->log(text,LogType::WARNING)
#define LOG_REALERROR(text) RenderWindow::Get()->log(text,LogType::REALERROR)
